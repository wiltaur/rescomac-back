...
{
    public class ParametroControllerTests
    {
        private ParametroController _currentController;
        private readonly Mock<IPropietarioService> _propiedadService = new();


        public ParametroControllerTests()
        {
            _currentController = new ParametroController(_propiedadService.Object);
        }
